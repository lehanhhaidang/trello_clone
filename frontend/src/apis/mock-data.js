export const mockData = {
  board: {
    _id: 'board-id-01',
    title: 'MaidenDev MERN Stack Board',
    ...
    columns: [
      ...
      },
      {
        ...
        // Xử lý khi Column không có Card, tạo một loại card đặc biệt (FE_PlaceholderCard) từ FE
        // Mỗi column chỉ chưa một placeholder card duy nhất
        // Khi kéo thả card vào column này, sẽ xóa placeholder card đi
        // Khi kéo thả card ra ngoài column này, sẽ tạo lại placeholder card
        // Khi xóa column này, sẽ xóa luôn placeholder card này
